const errorCodes = {
    ...
    USERNAME_ALREADY_USING : "That username already exists",

    /* EMAIL ERRORS */
    EMAIL_EMPTY : "Email cannot be empty",
    EMAIL_ALREADY_USING : "That email address already exists",
    EMAIL_NOT_VALIDATED : "Email cannot validated, send an validated email",
